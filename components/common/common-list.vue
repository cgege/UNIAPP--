<template>
	<view class="p-2">
		<view>
			...
			<view class="flex justify-between align-center">
				<view class="flex align-center">
						...
						<!-- 头像 -->
						<view >
							<image v-if="item.userpic" class="rounded-circle mr-2" :src="item.userpic" @click="openSpace" style="width: 65rpx;height: 65rpx;" mode="widthFix" lazy-load></image>
						</view>
		...
		<view @click="openDetail" >
			<image class="rounded w-100"  :src="item.titlepic" style="height: 355rpx;margin-top: 6rpx;" lazy-load></image>
		</view>
		<!-- 图标按钮 -->
